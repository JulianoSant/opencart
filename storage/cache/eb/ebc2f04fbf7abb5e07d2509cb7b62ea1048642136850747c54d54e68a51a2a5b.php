...
/* basico/template/common/cart.twig */
class __TwigTemplate_42ebc21cb4615c88adc0035d16fb3de753ed1001b5ce0e27ecdbe4807ff286e2 extends Twig_Template
{
...
";
    ...
    {
        return "basico/template/common/cart.twig";
    }
...
/*         <tr>*/
/*           <td class="text-center">{% if product.thumb %} <a href="{{ product.href }}"><img src="{{ product.thumb }}" loading="lazy" alt="{{ product.name }}" title="{{ product.name }}" class="img-thumbnail" /></a> {% endif %}</td>*/
...
/*         <tr>*/
/*           <td class="text-center">{% if voucher.thumb %} <img src="{{ voucher.thumb }}" loading="lazy" alt="{{ voucher.description }}" title="{{ voucher.description }}" class="img-thumbnail" />{% endif %}</td>*/
