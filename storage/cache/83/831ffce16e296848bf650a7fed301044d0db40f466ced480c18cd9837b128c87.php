...
class __TwigTemplate_6a583a16cb7d73203afb8c61c26217e1005b63404f0784cb8a21ee4b93e64375 extends Twig_Template
{
    ...
    ";
      ...
      <div class=\"panel-body\">
            ...
            <table class=\"table table-bordered table-hover\">
              <thead>
                <tr>
                  ...
                  <td class=\"text-left\">";
        // line 39
        if (((isset($context["sort"]) ? $context["sort"] : null) == "rd.name")) {
            // line 40
            echo "                    <a href=\"";
        ...
        echo "</td>
                  <td class=\"text-right\">";
        // line 44
        if (((isset($context["sort"]) ? $context["sort"] : null) == "r.sort_order")) {
            // line 45
            echo "                    <a href=\"";
...
/*                 <tr>*/
/*                   <td class="text-center" width="1"><input type="checkbox" onclick="$('input[name*=\'selected\']').prop('checked', this.checked);" /></td>*/
/*                   <td class="text-left">{% if sort == 'rd.name' %}*/
/*                     <a href="{{ sort_name }}" class="{{ order|lower }}">{{ column_name }}</a>*/
/*                     {% else %}*/
/*                     <a href="{{ sort_name }}">{{ column_name }}</a>*/
/*                     {% endif %}</td>*/
/*                   <td class="text-right">{% if sort == 'r.sort_order' %}*/
