...
/* basico/template/product/product.twig */
class __TwigTemplate_603796c68bbfd0b5a20d34f42b135bf314bc961648f06ec5781acbbe6a2cf757 extends Twig_Template
{
...
";
    ...
    {
        return "basico/template/product/product.twig";
    }
...
/*           <ul class="thumbnails">*/
/*             {% if thumb %}*/
/*             <li><a class="thumbnail" href="{{ popup }}" title="{{ heading_title }}"><img src="{{ thumb }}" loading="lazy" title="{{ heading_title }}" alt="{{ heading_title }}" /></a></li>*/
/*             {% endif %}*/
/*             {% if images %}*/
/*             {% for image in images %}*/
