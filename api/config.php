<?php
// HTTP
define('HTTP_SERVER', 'http://localhost/opencart/api/');
define('HTTP_CATALOG', 'http://localhost/opencart/');

// HTTPS
define('HTTPS_SERVER', 'http://localhost/opencart/api/');
define('HTTPS_CATALOG', 'http://localhost/opencart/');

// DIR
define('DIR_APPLICATION', 'C:/xampp/htdocs/opencart/api/');
define('DIR_SYSTEM', 'C:/xampp/htdocs/opencart/system/');
define('DIR_IMAGE', 'C:/xampp/htdocs/opencart/image/');
define('DIR_WEBHOOK', 'C:/xampp/htdocs/opencart/webhook/');
